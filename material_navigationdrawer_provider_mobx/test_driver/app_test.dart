...
void main() {
  group('App', () {
    ...
    // Note: the approach for finding and opening the drawer is more of a workaround. See https://github.com/flutter/flutter/issues/9002
    ...
    test('switching pages works', () async {
      await _switchToGalleryPage(driver, drawerIconFinder);
      await _switchToSlideshowPage(driver, drawerIconFinder);
      await _switchToHomePage(driver, drawerIconFinder);
    });
